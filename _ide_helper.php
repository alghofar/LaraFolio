...
class Navigation extends Tyloo\Facades\Navigation{
	/**
	 ...
	 * @static 
	 */
	 public static function __construct($config, $auth){
		 Tyloo\Services\Navigation\Builder::__construct($config, $auth);
	 }
	 ...
	 * @static 
	 */
	 public static function make($url, $type = 'menu'){
		return Tyloo\Services\Navigation\Builder::make($url, $type);
	 }
